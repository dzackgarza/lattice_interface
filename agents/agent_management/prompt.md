...
Read the logs. Diagnose what failed and why. Identify anti-patterns in prompts, playbooks, and memories that produce the failures. Fix them.
...
Fix the root causes found in Goal 2. Edits to prompts, playbooks, and memories are the primary output of this task. Delete memories that are changelogs. Remove completion-cliff language. Restore or add explicit banned-behavior statements where they were missing or deleted.
